                    ...
                    <div class="row">
                        <div class="col-md-3 col-sm-6 col-12">
                            <div class="info-box" style="height: 92px;">
                                <span class="info-box-icon bg-info">
                                    <a href="{{url('/ministerios/pdf')}}" target="_blank">
                                        <i class="bi bi-printer"></i>
                                    </a>
                                </span>
                                <div class="info-box-content">
                                    <span class="info-box-text">Imprimir Reporte</span>
                                    <span class="info-box-number">Ministerios</span>
                                </div>
                        ...
                        <div class="col-md-6">
                            <div class="info-box">
                                ...
                                <div class="info-box-content">
                                    <form action="{{url('/ministerios/pdf_fechas')}}" target="_blank" method="get">
                                        <div class="row">
                                            <div class="col-md-4">
