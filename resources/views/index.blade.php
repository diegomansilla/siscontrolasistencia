    ...
    <div class="row">
        ...
        <div class="col-lg-3">
            ...
            <div class="small-box bg-warning" style="height: 160px;">
                <div class="inner">
                    <?php $contador_de_usuarios = 0; ?> @foreach($usuarios as $usuario)
                    <?php $contador_de_usuarios = $contador_de_usuarios + 1; ?> @endforeach
                    <h3>
        ...
        <div class="col-lg-3">
            ...
            <div class="small-box bg-success" style="height: 160px;">
                <div class="inner">
                    <?php $contador_de_miembros = 0; ?> @foreach($miembros as $miembro)
                    <?php $contador_de_miembros = $contador_de_miembros + 1; ?> @endforeach
                    <h3>
        ...
        <div class="col-lg-3">
            ...
            <div class="small-box bg-info" style="height: 160px;">
                <div class="inner">
                    <?php $contador_de_ministerio = 0; ?> @foreach($ministerios as $ministerio)
                    <?php $contador_de_ministerio = $contador_de_ministerio + 1; ?> @endforeach
                    <h3>
        ...
        <div class="col-lg-3">
            ...
            <div class="small-box bg-primary" style="height: 160px;">
                <div class="inner">
                    <?php $contador_de_asistencia = 0; ?> @foreach($asistencias as $asistencia)
                    <?php $contador_de_asistencia = $contador_de_asistencia + 1; ?> @endforeach
                    <h3>
